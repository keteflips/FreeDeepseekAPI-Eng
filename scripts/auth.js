...
function removeLocalAuth() {
  ...
  console.log('Removed deepseek-auth.json. Chrome profile kept so the browser is not logged out unnecessarily.');
}
function printHelp() {
  divider();
  console.log('FreeDeepseekAPI — DeepSeek Web login manager');
  ...
  console.log('Without options an interactive menu starts.');
  divider();
}
async function menu() {
  while (true) {
    ...
    divider();
    console.log('Menu:');
    console.log('1 - Authenticate / refresh DeepSeek login');
